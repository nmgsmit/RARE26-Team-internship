...
PRETRAIN_EPOCHS=50 \
BATCH_SIZE=32 \
sbatch --export=EXPERIMENT_ID,BACKBONES_CSV,HEAD_TYPE,PRETRAIN_LOSS,LR,TEMPERATURE,BASE_TEMPERATURE,LAMBDA_SUPPRO,LAMBDA_SUPMIN,PRETRAIN_EPOCHS,BATCH_SIZE jobscript_slurm.sh
