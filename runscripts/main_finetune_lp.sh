#!/usr/bin/env bash
# Finetune: Linear probe head on the encoder trained by main_pretrain.sh.
...
export EXPERIMENT_ID="best_model_lp"
export EXPERIMENT_SAVE_SUBDIR="best_model/finetune/lp"
